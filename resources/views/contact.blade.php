		...
		<div class="team_container">
			<div class="row" style="display: flex; align-items: center; justify-content: center">
				<div class="col-lg-3 col-sm-6">
					...
					<div class="social_box">
						...
						<a href="https://www.linkedin.com/in/nanda-revan-saputro-3b89ab284/">
						<i class="fa fa-linkedin" aria-hidden="true"></i>
						</a>
						<a href="https://www.instagram.com/ravenn_17/">
						<i class="fa fa-instagram" aria-hidden="true"></i>
						</a>
						<a href="https://www.youtube.com/@nandarevansaputro016">
			...
			<div class="row" style="display: flex; align-items: center; justify-content: center">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="box ">
					<div class="img-box">
						<img src="{{ asset('assets/images/mekar1.jpg') }}" class="img1" alt="">
					</div>
					<div class="detail-box">
						<h5>
						RR. Mekar Ageng Kinasti, S.T., M.T.
						</h5>
						<p>
				...
				<div class="col-lg-3 col-sm-6">
					...
					<div class="detail-box">
						...
						<p>
						Deputi Manajer Transfer Teknologi
						</p>
					</div>
					<div class="social_box">
						<a href="#">
						...
						<a href="https://www.instagram.com/caesar_4_4">
						<i class="fa fa-instagram" aria-hidden="true"></i>
						</a>
