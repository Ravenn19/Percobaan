...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            {{-- <img href="https://technopark.itpln.ac.id/assets/images/stp1.png" alt="Company Logo" class="email-logo"> --}}
            <h1>KONFIRMASI PENYEWAAN LABORATORIUM</h1>
        </div>

        <!-- Content -->
        <div class="email-content">
            <p>Halo Tim Administrasi,</p>
            <p>Berikut detail permohonan penyewaan laboratorium yang baru saja diterima:</p>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-primary">
                            @if($reservation['applicantType'] == 'dosen_mahasiswa')
                                Dosen/Mahasiswa
                            @else
                                Lembaga Eksternal
                            @endif
            ...
            <table class="detail-table">
                <tr>
                    ...
                    <td><strong>{{ $reservation['lab'] ?? 'N/A' }}</strong></td>
                </tr>
                <tr>
                    <th>Tanggal</th>
