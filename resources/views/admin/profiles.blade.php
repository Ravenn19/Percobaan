            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('admin.profiles') }}">Profile</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card p-3 shadow-sm">
                                    ...
                                    @if($user->profil_startup_path)
                                        <div class="border p-2 rounded mb-2" style="background: #f8f9fa;">
                                            <strong>Preview Profil Startup:</strong>
                                        </div>
                                        <a href="{{ route('admin.download', ['id' => $user->id, 'type' => 'profil_startup']) }}" class="btn btn-primary btn-sm" target="_blank">
                                            Download Profil Startup
                                        </a>
                                    @else
                            ...
                            @empty
                            <p class="text-muted">Belum ada profil startup yang diupload.</p>
                            @endforelse
                        </div>
                    </div>
