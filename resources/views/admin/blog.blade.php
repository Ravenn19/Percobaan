            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('admin.blog') }}">Blog</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <!-- Begin Page Content (-->
                    ...
                    <div class="container my-4">
                        ...
                        @if($blogs->isEmpty())
                            <p>User belum membuat blog.</p>
                        @else
                            <div class="blog-list" style="border:1px solid #ccc; padding:10px;">
                                @foreach($blogs as $blog)
                                    <div style="margin-bottom: 20px;">
                                        ...
                                        <button class="btn btn-primary toggle-btn" onclick="toggleDetail({{ $blog->id }})" id="toggleBtn-{{ $blog->id }}">
                                            Read More
                                        </button>

                                        <div id="blog-detail-{{ $blog->id }}" style="display:none; margin-top:15px; border-top:1px solid #ccc; padding-top:10px;">
                                            <h4>Detail Blog:</h4>
                                            <p>{!! nl2br(e($blog->content)) !!}</p>
                                            @if($blog->image_path)
                                                <img src="{{ asset('storage/' . $blog->image_path) }}" alt="Blog Image" style="max-width:100%; height:auto;">
                                            @endif
                                        </div>
                                    </div>
                                    <hr>
                    ...
                    <script>
                        function toggleDetail(id) {
                            const detailDiv = document.getElementById('blog-detail-' + id);
