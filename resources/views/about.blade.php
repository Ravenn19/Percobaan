...
<body class="sub_page">
  ...
  <div class="hero_area">
	...
	<!-- BEGIN ABOUT -->
		<section class="about-us" style="margin: 100px;">
                <div class="container">
                    <div class="row align-items-center">
						...
						<div class="about-us-image position-relative" data-aos="fade-right" data-aos-delay="500" style="max-width: 100%; display: inline-block;">
							...
							<!-- Card Kiri - Biru -->
							<div class="rating-card left-center glass-card" style="background-color: #0984e3;">
								<h3>4.7</h3>
								<ul class="ratings d-flex">
									<li><i class="fas fa-star"></i></li>
									<li><i class="fas fa-star"></i></li>
                        ...
                        <div class="col-lg-6">
                            <div class="about-us-text" data-aos="fade-up">
                                <div class="sub-heading">
                                    <h2> About Science Techno Park IT PLN</h2>
                                    <p>
	...
	<!-- BEGIN WORK SOLUTION -->
		<section class="about-solution d-md-none d-none d-lg-block">
                <div class="container">
