		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav" style="padding: 30px; font-size:12px">
					...
					<li class="nav-item active">
						<!-- Inovasi -->
						<a class="nav-link" hhref="{{ route('inovasi') }}">Inovasi</a>
					</li>
					<li class="nav-item">
						<!-- HKI -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="project-wrapper" data-aos="fade-right">
                                <div class="project-wrapper-image">
                                    <img style="width: 150px; padding: 15px; margin: 15px" src="{{ asset('assets/new_asset/img/banner/banner05.jpg') }}" alt="image" />
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="project-wrapper" data-aos="fade-left" data-aos-delay="300">
                                <div class="project-wrapper-image">
                                    <img style="width: 150px; padding: 15px; margin: 15px" src="{{ asset('assets/new_asset/img/banner/banner08.jpg') }}" alt="image" />
                                </div>
                                <div class="project-wrapper-title">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="project-wrapper" data-aos="fade-right" data-aos-delay="400">
                                <div class="project-wrapper-image">
                                    <img style="width: 150px; padding: 15px; margin: 15px" src="{{ asset('assets/new_asset/img/banner/banner06.jpg') }}" alt="image" />
                                </div>
                                <div class="project-wrapper-title">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="project-wrapper" data-aos="fade-left" data-aos-delay="500">
                                <div class="project-wrapper-image">
                                    <img style="width: 150px; padding: 15px; margin: 15px" src="{{ asset('assets/new_asset/img/banner/banner03.png') }}" alt="image" />
                                </div>
                                <div class="project-wrapper-title">
